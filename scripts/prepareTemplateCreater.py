...
class prepareTemplate:
    ...
    def create_exe(self, name):
        ...
        #Linux
        created = subprocess.call("pyinstaller --noconfirm --onefile --console --icon /var/www/scripts/software_install.ico --distpath /var/www/html/installpy/ /var/www/html/installpy/" + name, shell=True);        
        if(created == 0):
